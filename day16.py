...
def removeLoop(head):
   ...
   #detect the loop
    ...
    while ptr2!=ptr1:
        c = c+1
        ptr1 = ptr1.next
    c = c+1 #number of nodes in loop

    #set ptr1 at head and ptr2 cth positions from the head
    i = 0
    ptr2 = ptr1 = head
    ...
    #this is done by moving both the pointers as same speed
    while ptr1 != ptr2:
        ptr1 =ptr1.next
        ptr2 = ptr2.next

    #iterate to the last node of the loop and set its next to None
